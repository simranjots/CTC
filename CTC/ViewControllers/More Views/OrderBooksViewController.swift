...
class OrderBooksViewController: UIViewController {
    ...
    let booksDescription = [
        "The 201 Day Achievement Principle Book explains the origin of this powerful system offering a whole new perspective on achievement without the typical pressure or guilt",
...
extension OrderBooksViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        switch booksImageView[indexPath.row] {
