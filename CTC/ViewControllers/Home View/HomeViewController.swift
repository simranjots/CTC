...
//        // MARK: Testing
//                var date5 = DateComponents(calendar: .current, year: 2019, month: 4, day: 7).date!
//        print("Day : \(date5.getDayOfWeek())")
        ...
        var dateComp = Calendar.current.dateComponents([.year, .month, .day, .hour, .minute, .second], from: dateForDateComp)
...
//        let date1 = Date()
//        let date2 = Date().addingTimeInterval(400)
//
//        if(date1 > date2){
//            print("Date 1 < date 2")
//        }else {
...
//        createDoneToolBar(textField: dateTextField)
//        createDoneToolBar(textField: practiceStartedDate)
...
//        dbHelper.getPracticeHistory(user: userObject)
        
        
        //MARK: initial of storyboard
...
//        var date5 = DateComponents(calendar: .current, year: 2019, month: 3, day: 31).date!
//        let dateArray = date5.dateFormate()!.getDates(date: Date().dateFormate()!)
//        
//        for Practice in practices{
//                    let dateArray = (Practice.startedday! as Date).dateFormate()!.getDates(date: Date().dateFormate()!)
//
//            for dateobject in dateArray{
//
//    //
//                    dbHelper.addPracticeData(note: "Manual - \(dateobject)", practised: true, practice: Practice, date: dateobject)
//    //
//
//            }
//        }
...
//            print(self.isSwitchOn(practice: practices[indexPath.row + indexPath.section], practicesData: practicesData))
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        var destination = segue.destination as! addTodayViewController
...
//            isUpdating = false
    ...
    @IBAction func iconImageButtonTapped(_ sender: Any) {
        ...
        for icon in moreOptionIconList{
           ...
           var action = UIAlertAction(title: icon, style: .default){action in self.changeResolutionIcon(imageName: icon)}
